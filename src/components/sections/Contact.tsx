            ...
            <div className="prose dark:prose-invert">
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3 text-base text-gray-500 dark:text-gray-300">
                    <p>torresmartins.hugo@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <div className="flex-shrink-0">
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="py-3 px-4 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md"
